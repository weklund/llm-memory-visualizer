...
3. **Exact throughput multipliers** (e.g. “24× vs HuggingFace”) — Benchmark- and version-dependent; teach *mechanism*, show *example numbers* with source.
...
6. **“Infinite context” claims** (StreamingLLM-style) — Means *streaming with bounded cache*, not lossless infinite memory of all past tokens.
